          ...
          <table className="w-full">
            <thead>
              <tr className="border-b bg-secondary">
                ...
                <th className="px-4 py-2.5 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">RECRUITER</th>
                <th className="w-10"></th>
              </tr>
            </thead>
            <tbody className="divide-y">
              {jobs.map(job => <tr key={job.id} className="hover:bg-accent/50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-flex items-center text-xs font-medium ${job.stage === "Active" ? "text-foreground" : job.stage === "Paused" ? "text-muted-foreground" : "text-foreground"}`}>
                      {job.stage}
                    </span>
                  </td>
